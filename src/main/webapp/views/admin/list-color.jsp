...
<script type="text/javascript">
	function deleteProductColor(id) {
		if(confirm("Bạn có muốn xóa "+id+" không")){
			window.location = "deleteProductColor?id="+id;
		}
	}
</script>
	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Product Color Manage</li>
				</ol>
			</nav>
		</div>
		<!-- End Page Title -->
		...
		<section class="section dashboard">
			<div class="row">
				 <div class="card">
            <div class="card-body">
              	<h5 class="card-title">Danh mục màu sản phẩm</h5>
              <!-- Default Table -->
              <table id="myTable" class="table">
                ...
                <tbody>            	
					<c:forEach items="${ProductColor}" var="pColor">
                		<tr>
                			<td>${ pColor.product.productName }</td>
							<td>${pColor.colorName}</td>
							<td>
								<a href="#" onclick="deleteProductColor('${pColor.colorId}')"><i class='bx bxs-trash-alt'></i></a>
							</td>
						</tr>
                	</c:forEach>  
                </tbody>
