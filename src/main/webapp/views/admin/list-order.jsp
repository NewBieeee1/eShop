	...
	<main id="main" class="main">
		...
		<section class="section dashboard">
			<div class="row">
				 <div class="card">
            <div class="card-body">
              	<h5 class="card-title">Danh mục đơn đặt hàng</h5>
              <!-- Default Table -->
              <table id="myTable" class="table">
                ...
                <tbody>
                <c:set value="requestScope.dao" var="dao"></c:set>
                	<c:forEach items="${orders}" var="o">
                		<tr>
							...
							<td>${ o.size }</td>
							<td>${ o.note }</td>
							<td>${ o.transportFee }</td>
							<td>
								<a href="updateo?id=${o.orderId}" ><i class='bx bxs-wrench'></i></a>
								<a href="#" onclick="deleteOrder('${o.orderId}')"><i class='bx bxs-trash-alt'></i></a>
							</td>
						</tr>
                	</c:forEach>                               
                </tbody>
