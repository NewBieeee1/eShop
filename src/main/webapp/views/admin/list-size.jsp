...
<title>Danh sách rom sản phẩm</title>
...
<script type="text/javascript">
	function deleteProductSize(id) {
		if(confirm("Bạn có muốn xóa "+id+" không")){
			window.location = "deleteProductSize?id="+id;
		}
	}
</script>
	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Product Size Manage</li>
				</ol>
			</nav>
		</div>
		<!-- End Page Title -->
		...
		<section class="section dashboard">
			<div class="row">
				 <div class="card">
            <div class="card-body">
              	<h5 class="card-title">Danh mục Rom sản phẩm</h5>
              ...
              <table id="myTable" class="table">
                ...
                <tbody>
                	<c:forEach items="${ProductSize}" var="pSize">
                		<tr>
                			<td>${ pSize.product.productName }</td>
							<td>${pSize.sizeName}</td>
							<td>
								<a href="#" onclick="deleteProductSize('${pSize.sizeId}')"><i class='bx bxs-trash-alt'></i></a>
							</td>
						</tr>
                	</c:forEach>  
                </tbody>
