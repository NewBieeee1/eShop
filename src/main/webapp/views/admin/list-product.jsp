                	...
                	<c:forEach items="${products}" var="p">
                		<tr>
							...
							<td>
								...
								<a href="addProductImageMain?id=${p.productId}" ><i class='bx bxs-image-add'>M</i></a>
								<a href="addProductImageSub?id=${p.productId}"><i class='bx bxs-image-add'>S</i></a>
							</td>
							<td>
							...
							<td>
								<a href="updatep-detail?id=${p.productId}" ><i class='bx bxs-wrench'></i></a>
							</td>
							<td>
								<a href="updatep?id=${p.productId}" ><i class='bx bxs-wrench'></i></a>
								<a href="#" onclick="deleteProduct('${p.productId}')"><i class='bx bxs-trash-alt'></i></a>
							</td>
						</tr>
                	</c:forEach>                               
                </tbody>
